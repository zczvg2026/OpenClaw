...
## 【确认】Johnson要求我主动读IMA知识库来加深理解（2026-04-05）
- **规则**：遇到Johnson的背景/公司/行业问题，应主动去IMA知识库读取一手资料，而不是等他告诉我所有事
- **Why**：Johnson已经把所有公司资料上传到IMA，我主动读比等他转述效率更高、信息更完整
- **How to apply**：涉及Johnson公司/行业背景的问题 → 先查IMA知识库 → 再结合已掌握的信息给出判断
- **相关记忆**：IMA知识库19篇笔记，projects.md有摘要

## 【确认】混沌创商院是Johnson的"实战打磨"场所，非学知识（2026-04-05）
- **规则**：Johnson上混沌创商院课程不是去学知识的，是带着自己的问题去实战打磨
- **Why**：课程里那些讨论都是Johnson在提出自己的真实问题；他是带着太擎/域擎/ENERGY CELL的实际困境去研讨
- **How to apply**：后续涉及Johnson公司战略/创新方向时，可引用混沌创商院的方法论（单点战略、贝叶斯、右上角理论、破局创新方法论）作为参考框架
- **相关记忆**：IMA知识库19篇笔记，projects.md有摘要
